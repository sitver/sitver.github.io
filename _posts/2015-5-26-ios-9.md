...
**Methodology:** These calculations are based on research, past results, and a formula for calculating binary probabilities. These are very rough estimates, and subjective, though we believe them to be accurate indicators, based on past results. The process is similar to how casinos calculate odds for sports-betting, if you'd like to research further.